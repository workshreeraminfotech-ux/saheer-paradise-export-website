          ...
          <div className="cta-banner-grid">
            ...
            <div className="cta-banner-image-wrap">
              <img
                ...
                alt="Connect with Saheer Paradise Export"
              />
            ...
            <div className="cta-banner-content">
              <h2 className="cta-banner-title">
                Connect With Us Today for <span style={{ color: 'var(--gold)' }}>Bulk Maritime Vessel Exports</span>
              </h2>

              <p className="cta-banner-desc">
                Partner with Saheer Paradise Export for premium spices, oil seeds, grains, and agricultural produce delivered to your port with guaranteed purity and complete export compliance.
              </p>
