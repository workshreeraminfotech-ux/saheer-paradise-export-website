...
export default function WhatsAppFloat() {
  return (
    <div className="wa-float-container">
      <a
        href="https://api.whatsapp.com/send?phone=919377988770&text=Hello%20Saheer%20Paradise%20Export,%20I%20am%20interested%20in%20your%20export%20commodities."
        target="_blank"
        rel="noopener noreferrer"
        className="wa-float-btn"
        aria-label="Chat with Saheer Paradise Export on WhatsApp"
        title="Chat on WhatsApp (+91 93779 88770)"
      >
